$(document).ready(function() {
  ...
  var editLayer = new L.Polyline([], editLine)
    ...
    wax.tilejson(url, function(tilejson) {
      ...
      var home = {coords: new L.LatLng(51.33088838086245,1.2277658081054688)}
        , mapbox = new wax.leaf.connector(tilejson)
        , mapnik = new L.TileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {opacity: 1})
        , map = new L.Map('map', {center: home.coords, zoom: zoom, layers: [mapnik,routeLayer,startingPointLayer,pubLayer,wantsumLayer,rbLayer,monumentLayer,churchLayer,castleLayer,editLayer]})
        , baseMaps = {Mapnik: mapnik, Mapbox: mapbox}
